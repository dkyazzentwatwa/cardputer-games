...
constexpr int16_t CARDPUTER_GAME_VIEWPORT_X = (CARDPUTER_GAME_DISPLAY_WIDTH - SCREEN_WIDTH) / 2;
constexpr int16_t CARDPUTER_GAME_VIEWPORT_Y = (CARDPUTER_GAME_DISPLAY_HEIGHT - SCREEN_HEIGHT) / 2;
